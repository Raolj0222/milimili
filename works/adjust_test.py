...
def get_neigou(headers):
    response = requests.get(
        f'https://dash.adjust.com/control-center/reports-service/report?app_token__in=3dle7bbjgwhs&date_period={date}:{date}&dimensions=app,country_code&metrics=adjust_purchases_revenue',
        headers=headers)
